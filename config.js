...
module.exports = {
    ...
    ALIVEIMG: process.env.ALIVEIMG === undefined ? 'https://pixel-creation.com/wp-content/uploads/assassins-creed-the-ezio-collection-wallpaper-10440-baltana-800x800.jpg' : process.env.ALIVEIMG,
    ...
    ALIVETEXT: process.env.ALIVENAME === undefined ?'*S U Z Y*\n      A L I V E  ' : process.env.ALIVENAME,
